...
struct par{int ch=0;float phi=0;float pt=0;float mass=0;float angle=0;float eta=0;float theta=0;float en=0;float p=0;};

void bpark::Loop(){
    // TFile *out= new TFile("BparkhistosRight.root","RECREATE");
    TRandom2 *rand=new TRandom2();
    TH1F *h1_a1g = new TH1F("1_angle1g","Angle between mu1 and same charge pion, set 1, Good",300,-0.2,3.5);
    TH1F *h1_a2g = new TH1F("1_angle2g","Angle between mu1 and opp charge pion, set 1, Good",300,-1.7,3.5);
    TH1F *h1_a1b = new TH1F("1_angle1b","Angle between mu1 and same charge pion, set 1,Bad",300,-0.2,3.5);
    TH1F *h1_a2b = new TH1F("1_angle2b","Angle between mu1 and opp charge pion, set 1, Bad",300,-3.5,3.5);
    
    TH1F *h2_a1g = new TH1F("2_angle1g","Angle between mu1 and same charge pion, set 2, Good",200,-0.2,1.7);
    TH1F *h2_a2g = new TH1F("2_angle2g","Angle between mu1 and opp charge pion, set 2, Good",200,-1.7,1.7);
    TH1F *h2_a1b = new TH1F("2_angle1b","Angle between mu1 and same charge pion, set 2, Bad",200,-0.2,3.5);
    TH1F *h2_a2b = new TH1F("2_angle2b","Angle between mu1 and opp charge pion, set 2, Bad",200,-3.5,3.5);

    TH1F *h3_a1g = new TH1F("3_angle1g","Angle between mu1 and same charge pion, set 3, Good",300,-0.2,1.7);
    TH1F *h3_a2g = new TH1F("3_angle2g","Angle between mu1 and opp charge pion, set 3, Good",300,-1.7,1.7);
    TH1F *h3_a1b = new TH1F("3_angle1b","Angle between mu1 and same charge pion, set 3, Bad",300,-0.2,3.5);
    TH1F *h3_a2b = new TH1F("3_angle2b","Angle between mu1 and opp charge pion, set 3, Bad",300,-3.5,3.5);
    
    TH1F *h4_a1g = new TH1F("4_angle1g","Angle between mu1 and same charge pion, set 4, Good",200,-0.2,2.5);
    TH1F *h4_a2g = new TH1F("4_angle2g","Angle between mu1 and opp charge pion, set 4, Good",200,-1.7,2.5);
    TH1F *h4_a1b = new TH1F("4_angle1b","Angle between mu1 and same charge pion, set 4, Bad",200,-0.2,3.5);
    TH1F *h4_a2b = new TH1F("4_angle2b","Angle between mu1 and opp charge pion, set 4, Bad",200,-3.5,3.5);
    
    TH1F *hrhomass1_1 = new TH1F("hrhomass1_1","Rhomass1, set 1",300,0,2);
    TH1F *hrhomass1_2 = new TH1F("hrhomass1_2","Rhomass2, set 1",300,0,2);
    TH1F *whrhomass1_1 = new TH1F("whrhomass1_1","Rhomass",300,0,2);
    TH1F *hrhomass1_1c = new TH1F("hrhomass1_1c","Rhomass1, set 1",300,0,2);
    TH1F *hrhomass1_2c = new TH1F("hrhomass1_2c","Rhomass2, set 1",300,0,2);
    
    TH1F *hrhomass2_1 = new TH1F("hrhomass3_1","Rhomass1, set 2",200,0,2);
    TH1F *hrhomass2_2 = new TH1F("hrhomass3_2","Rhomass2, set 2",200,0,2);
    TH1F *whrhomass2_1 = new TH1F("whrhomass3_1","Rhomass",200,0,2);
    TH1F *hrhomass2_1c = new TH1F("hrhomass3_1c","Rhomass1,set 2",200,0,2);
    TH1F *hrhomass2_2c = new TH1F("hrhomass3_2c","Rhomass2,set 2",200,0,2);
    
    TH1F *hrhomass1l = new TH1F("hrhomass1l","Rhomass, Pt<4,  set 1",200,0,2);
    TH1F *hrhomass1m = new TH1F("hrhomass1m","Rhomass, 4<Pt<7, set 1",200,0,2);
    TH1F *hrhomass1h = new TH1F("hrhomass1h","Rhomass, 7<Pt<14, set 1",200,0,2);
    TH1F *hrhomass1vh = new TH1F("hrhomass1vh","Rhomass, Pt>14, set 1",200,0,2);
    TH1F *hwrhomass1 = new TH1F("hwrhomass1","Rhomass",200,0,2);
    
    TH1F *hkmass1l = new TH1F("hkmass1l","Rhomass, Pt<4,  set 1",200,0,2);
    TH1F *hkmass1m = new TH1F("hkmass1m","Rhomass, 4<Pt<7, set 1",200,0,2);
    TH1F *hkmass1h = new TH1F("hkmass1h","Rhomass, 7<Pt<14, set 1",200,0,2);
    TH1F *hkmass1vh = new TH1F("hkmass1vh","Rhomass, Pt>14, set 1",200,0,2);
    TH1F *hwkmass1 = new TH1F("hwkmass","Rhomass",200,0,2);
    
    TH1F *hkmass2l = new TH1F("hkmass2l","Rhomass, Pt<4,  set 1",200,0,2);
    TH1F *hkmass2m = new TH1F("hkmass2m","Rhomass, 4<Pt<7, set 1",200,0,2);
    TH1F *hkmass2h = new TH1F("hkmass2h","Rhomass, 7<Pt<14, set 1",200,0,2);
    TH1F *hkmass2vh = new TH1F("hkmass2vh","Rhomass, Pt>14, set 1",200,0,2);
    TH1F *hwkmass2 = new TH1F("hwkmass2","Rhomass",200,0,2);
    
    TH1F *hrhomass2l = new TH1F("hrhomass2l","Rhomass, Pt<4, set 2",200,0,2);
    TH1F *hrhomass2m = new TH1F("hrhomass2m","Rhomass, 4<Pt<7, set 2",200,0,2);
    TH1F *hrhomass2h = new TH1F("hrhomass2h","Rhomass, 7<Pt<14, set 2",200,0,2);
    TH1F *hrhomass2vh = new TH1F("hrhomass2vh","Rhomass, Pt>14, set 2",200,0,2);
    TH1F *hwrhomass2 = new TH1F("hwrhomass2","Rhomass",200,0,2);
    
    TH1F *hkkmasstot1 = new TH1F("hkkmass1_1","Rhomass1,set 1",2000,0,4);
    TH1F *hkkmasstot2 = new TH1F("hkkmass1_2","Rhomass2,set 1",2000,0,4);
  //  TH1F *hwkmass = new TH1F("hwkmass","Rhomass2,set 2",300,0,4);
    
    TH2F *hmet1_lg = new TH2F("hmet1_lg","Angle between mu1 and MET, EN<10 GeV",300,-0.2,3.5,300,0,10);
    TH2F *hmet1_mg = new TH2F("hmet1_mg","Angle between mu1 and MET, 10<EN<20 GeV",300,-0.2,3.5,300,0,10);
    TH2F *hmet1_hg = new TH2F("hmet1_hg","Angle between mu1 and MET, 20<EN<30 GeV",300,-0.2,3.5,300,0,10);
    TH2F *hmet1_vhg = new TH2F("hmet1_vhg","Angle between mu1 and MET, EN>30 GeV",300,-0.2,3.5,300,0,10);
    
    TH2F *hmet2_lg = new TH2F("hmet2_lg","Angle between mu1 and MET, EN<10 GeV",300,-0.2,3.5,300,0,10);
    TH2F *hmet2_mg = new TH2F("hmet2_mg","Angle between mu1 and MET, 10<EN<20 GeV",300,-0.2,3.5,300,0,10);
    TH2F *hmet2_hg = new TH2F("hmet2_hg","Angle between mu1 and MET, 20<EN<30 GeV",300,-0.2,3.5,300,0,10);
    TH2F *hmet2_vhg = new TH2F("hmet2_vhg","Angle between mu1 and MET, EN>30 GeV",300,-0.2,3.5,300,0,10);
    
    TH1F *heta1_1g=new TH1F("heta1_1g","Eta mu & same ch pi, set 1, Good",300,-4,4);
    TH1F *heta1_1b=new TH1F("heta1_1b","Eta mu & same ch pi, set 1, Bad",300,-6,6);
    TH1F *heta1_2g=new TH1F("heta1_2g","Eta mu & opp ch pi, set 1, Good",300,-4,4);
    TH1F *heta1_2b=new TH1F("heta1_2b","Eta mu & opp ch pi, set 1, Bad",300,-6,6);
    
    TH1F *heta2_1g=new TH1F("heta2_1g","Eta mu & same ch pi, set 2, Good",200,-4,4);
    TH1F *heta2_1b=new TH1F("heta2_1b","Eta mu & same ch pi, set 2, Bad",200,-6,6);
    TH1F *heta2_2g=new TH1F("heta2_2g","Eta mu & opp ch pi, set 2, Good",200,-4,4);
    TH1F *heta2_2b=new TH1F("heta2_2b","Eta mu & opp ch pi, set 2, Bad",200,-6,6);
    
    TH1F *heta3_1g=new TH1F("heta3_1g","Eta mu & same ch pi, set 3, Good",300,-4,4);
    TH1F *heta3_1b=new TH1F("heta3_1b","Eta mu & same ch pi, set 3, Bad",300,-6,6);
    TH1F *heta3_2g=new TH1F("heta3_2g","Eta mu & opp ch pi, set 3, Good",300,-4,4);
    TH1F *heta3_2b=new TH1F("heta3_2b","Eta mu & opp ch pi, set 3, Bad",300,-6,6);
    
    TH1F *heta4_1g=new TH1F("heta4_1g","Eta mu & same ch pi, set 4, Good",100,-4,4);
    TH1F *heta4_1b=new TH1F("heta4_1b","Eta mu & same ch pi, set 4, Bad",100,-6,6);
    TH1F *heta4_2g=new TH1F("heta4_2g","Eta mu & opp ch pi, set 4, Good",100,-4,4);
    TH1F *heta4_2b=new TH1F("heta4_2b","Eta mu & opp ch pi, set 4, Bad",100,-6,6);
    ...
    TH1F *hmetrespi = new TH1F("hmetrespi","Angle between Met and Res Pt, set 1 ",300,-3.5,3.5);
