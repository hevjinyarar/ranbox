...
void tree::Loop(){
   // TFile *out= new TFile("histosRight.root","RECREATE");
    ...
    TH1F *h1_a1 = new TH1F("1_angle1","Angle between mu1 and same charge pion, set 1",100,-0.2,3.5);
    TH1F *h1_a2 = new TH1F("1_angle2","Angle between mu1 and diff charge pion, set 1",100,-3.5,3.5);

    TH1F *h3_a1 = new TH1F("3_angle1","Angle between mu1 and same charge pion, set 3",30,-0.2,3.5);
    TH1F *h3_a2 = new TH1F("3_angle2","Angle between mu1 and diff charge pion, set 3",30,-3.5,3.5);
    
    TH1F *hb1 = new TH1F("angleMB1","Angle between mu1 and B, set 1",70,-0.2,3.5);
    TH1F *hres1 = new TH1F("angleMR1","Angle between mu1 and res pi momentum, set 1",70,-0.2,3.5);
    TH1F *hresB1 = new TH1F("angleBR1","Angle between B and res pi momentum, set 1",70,-0.2,3.5);
    
    TH1F *hb3 = new TH1F("angleMB3","Angle between mu1 and B, set 3",30,-0.2,3.5);
    TH1F *hres3 = new TH1F("angleMR3","Angle between mu1 and res pi momentum, set 3",30,-0.2,3.5);
    TH1F *hresB3 = new TH1F("angleBR3","Angle between B and res pi momentum, set 3",30,-0.2,3.5);
    
    TH1F *hwh1 = new TH1F("hwangle1","Angle between mu1 and same charge pion",50,-0.2,3.5);
    TH1F *hwh2 = new TH1F("hwangle2","Angle between mu1 and diff charge pion",50,-3.5,3.5);
    
    TH1F *wh1 = new TH1F("wangle1","Angle between mu1 and same charge pion",70,-0.2,3.5);
    TH1F *wh2 = new TH1F("wangle2","Angle between mu1 and diff charge pion2",70,-3.5,3.5);
    
    TH1F *hwhb = new TH1F("hwangleMB","Angle between mu1 and B",60,-0.2,3.5);
    TH1F *hwhres = new TH1F("hwangleMR","Angle between mu1 and res pi momentum",60,-0.2,3.5);
    TH1F *hwhresB = new TH1F("hwangleBR","Angle between B and res pi momentum",60,-0.2,3.5);
    
    TH1F *whb = new TH1F("wangleMB","Angle between mu1 and B",70,-0.2,3.5);
    TH1F *whres = new TH1F("wangleMR","Angle between mu1 and res pi momentum",70,-0.2,3.5);
    TH1F *whresB = new TH1F("wangleBR","Angle between B and res pi momentum",70,-0.2,3.5);
    
    TH1F *hrate = new TH1F("rate","Rate: 1' cand vs 1' cand after checking all vs 2' and others cand ",2,-1,1);
    
    TH1F *hrhomass1_1 = new TH1F("hrhomass1_1","Rhomass1, set 1",70,-0.2,4);
    TH1F *hrhomass1_2 = new TH1F("hrhomass1_2","Rhomass2, set 1",70,-0.2,4);
    TH1F *whrhomass1_1 = new TH1F("whrhomass1_1","Rhomass",70,-0.2,4);
    TH1F *hrhomass1_1c = new TH1F("hrhomass1_1c","Rhomass1, set 1",70,-0.2,4);
    TH1F *hrhomass1_2c = new TH1F("hrhomass1_2c","Rhomass2, set 1",70,-0.2,4);
    
    TH1F *hrhomass3_1 = new TH1F("hrhomass3_1","Rhomass1, set 3",25,-0.2,4);
    TH1F *hrhomass3_2 = new TH1F("hrhomass3_2","Rhomass2, set 3",25,-0.2,4);
    TH1F *whrhomass3_1 = new TH1F("whrhomass3_1","Rhomass",25,-0.2,4);
    TH1F *hrhomass3_1c = new TH1F("hrhomass3_1c","Rhomass1,set 3",25,-0.2,4);
    TH1F *hrhomass3_2c = new TH1F("hrhomass3_2c","Rhomass2,set 3",25,-0.2,4);
    
    TH1F *heta1=new TH1F("heta1","Eta,set 1",100,-5,5);
    TH1F *heta3=new TH1F("heta3","Eta,set 3",40,-5,5);
    TH1F *wheta=new TH1F("wheta","Eta set 1",100,-5,5);
    TH1F *hwheta=new TH1F("hwheta","",100,-5,5);
    ...
    TH2F *hangle1_1 = new TH2F("A1_1vsMpt","Angle1_1 vs mu1 pt,set 1",70,0,60,70,-0.2,3.5);
    TH2F *hangle1_2 = new TH2F("A1_2vsMpt","Angle1_2 vs mu1 pt,set 1",70,0,60,70,-3.5,3.5);
    
    TH2F *hangle3_1 = new TH2F("A3_1vsMpt","Angle3_1 vs mu1 pt,set 3",70,0,60,40,-0.2,3.5);
    TH2F *hangle3_2 = new TH2F("A3_2vsMpt","Angle3_2 vs mu1 pt,set 3",70,0,60,40,-3.5,3.5);
    
    TH2F *hangle1_1vs2 = new TH2F("1_A1vsA2","Angle1 vs Angle2,set 1",70,-0.2,3.5,70,-3.5,3.5);
    TH2F *hangle3_1vs2 = new TH2F("3_A1vsA2","Angle1 vs Angle2,set 3",40,-0.2,3.5,40,-3.5,3.5);
    
    TH2F *hwhangle1 = new TH2F("hwA1vsMpt","",70,0,60,100,-0.2,3.5);
    TH2F *hwhangle2 = new TH2F("hwA2vsMpt","",70,0,60,100,-3.5,3.5);
    TH2F *hwhangle2d = new TH2F("hwA1vsA2","",70,-0.2,3.5,70,-3.5,3.5);
    
    TH2F *whangle1 = new TH2F("wA1vsMpt","",70,0,60,100,-0.2,3.5);
    TH2F *whangle2 = new TH2F("wA2vsMpt","",70,0,60,100,-3.5,3.5);
    TH2F *whangle2d = new TH2F("wA1vsA2","",70,-0.2,3.5,70,-3.5,3.5);
